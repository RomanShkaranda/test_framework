...
class TestCartPage:
    def test_is_cart_opened(self, open_cart_page):
    ...
    def test_is_product_added(self, open_main_page):
    ...
    @pytest.mark.smoke
    def test_is_product_deleted(self, open_main_page):
        main_page = open_main_page
        main_page.add_to_cart_backpack()
    ...
    @pytest.mark.smoke
    def test_continue_shopping(self, open_main_page):
        main_page = open_main_page
        main_page.add_to_cart_backpack()
    ...
    @pytest.mark.smoke
    def test_remove_one(self, open_main_page):
        main_page = open_main_page
        main_page.add_to_cart_backpack()
        main_page.add_to_cart_jacket()
        cart = main_page.open_cart_button()
